...
//             html += '<option value=' + (i + 1) + '>' + media[i] + '</option>'
//         }
...
//             html += '<option value=' + (i + 1) + '>' + law[i] + '</option>'
//         }
//         $('#law').append(html);
//     }
// });
...
$('#query').on('click', function() {
    ...
    //     mediaType = '';
    // } else {
    //     mediaType = $("#mediaType").find("option:selected").text()
    // }

    // if ($("#law").find("option:selected").val() === '0') {
    //     law = '';
    // } else {
    //     law = $("#law").find("option:selected").text()
    // }
    $.ajax({
