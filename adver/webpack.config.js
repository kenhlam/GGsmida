...
var config = {
	entry: { //配置入口文件，有几个写几个
		areaCount: './src/js/areaCount.js',
		brandCount: './src/js/brandCount.js',
		industryCount: './src/js/industryCount.js',
		mediaCount: './src/js/mediaCount.js',
		mediaTypeCount: './src/js/mediaTypeCount.js'
	},
	output: {
